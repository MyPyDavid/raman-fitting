...
class Exporter():
    ...
    def __init__(self, fitter, raw_out = True, plot=True, model_names_prefix= ['1st', '2nd']):
        self.fitter = fitter
    ...
    def export_from_list(self):
        FitRes = pd.concat([val.FitParameters for exp in self.fitter
    ...
    def export_fitting_plotting_models(self):
        ...
        for modname_2, fitres_2 in _2nd.items():
            ...
            for modname_1, fitres_1 in _1st.items():
                ...
                try:
                    fit_spectrum_plot(modname_1, modname_2, fitres_1, fitres_2,
                                      plot_Annotation=True, plot_Residuals=True)
                except Exception as e:
    ...
    def export_xls_from_spec(self, res_peak_spec):
        try:
            ...
            res_peak_spec.FitComponents.to_excel(
                res_peak_spec.extrainfo['DestFittingModel'].with_suffix('.xlsx'), index=False)
